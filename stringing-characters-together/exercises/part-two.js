...
console.log(dnaTwo.slice(4,7).toLowerCase());
console.log(dnaTwo.replace("TCG","CAT").toLowerCase().slice(0,3));
console.log(`${dnaTwo.slice(4,7).toLowerCase()}o ${dnaTwo.replace("TCG","CAT").toLowerCase().slice(0,3)}`);
